/*!
 * react-sketch-canvas v3.0.0 - https://github.com/vinothpandian/react-sketch-canvas
 * MIT Licensed
 */
...
var Paths_svgPath = function svgPath(paths, id, strokeWidth, strokeColor, command) {
...
var Paths_Paths = function Paths(_ref) {
  ...
  return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
    ...
    paths.map(function (path, id) {
      return Paths_svgPath(path.get('paths'), id, path.get('strokeWidth'), path.get('strokeColor'), bezierCommand);
    })
  );
};

Paths_Paths.propTypes = {
  paths: prop_types_default.a.instanceOf(List).isRequired
};

/* harmony default export */ var src_Paths = (Paths_Paths);
...
var Canvas_Canvas = function (_React$Component) {
  ...
  function Canvas(props) {
    ...
    _this.canvas = external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createRef();
    return _this;
  }
    ...
    return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
      ...
      external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
        ...
        external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
          'g',
          { id: 'canvasPenStrokes' },
          external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(src_Paths, { paths: paths })
        )
      )
    );
  };
...
Canvas_Canvas.propTypes = {
  paths: prop_types_default.a.instanceOf(List).isRequired,
  isDrawing: prop_types_default.a.bool.isRequired,
  onPointerDown: prop_types_default.a.func.isRequired,
  onPointerMove: prop_types_default.a.func.isRequired,
  onPointerUp: prop_types_default.a.func.isRequired,
  width: prop_types_default.a.string,
  height: prop_types_default.a.string,
  canvasColor: prop_types_default.a.string,
  background: prop_types_default.a.string,
  allowOnlyPointerType: prop_types_default.a.string,
  style: prop_types_default.a.objectOf(prop_types_default.a.string)
};

/* harmony default export */ var src_Canvas = (Canvas_Canvas);
...
var src_SvgSketchCanvas = function (_React$Component) {
  src_inherits(SvgSketchCanvas, _React$Component);

  function SvgSketchCanvas(props) {
    src_classCallCheck(this, SvgSketchCanvas);

    var _this = src_possibleConstructorReturn(this, _React$Component.call(this, props));
    ...
    _this.svgCanvas = external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createRef();
    return _this;
  }
  ...
  SvgSketchCanvas.prototype.render = function render() {
    ...
    return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(src_Canvas, {
      ref: this.svgCanvas,
      width: width,
      height: height,
...
src_SvgSketchCanvas.defaultProps = {
  width: '100%',
  height: '100%',
  canvasColor: 'white',
  strokeColor: 'red',
...
src_SvgSketchCanvas.propTypes = {
  ...
  eraserWidth: prop_types_default.a.number,
  allowOnlyPointerType: prop_types_default.a.string,
  style: prop_types_default.a.objectOf(prop_types_default.a.string)
};

/* harmony default export */ var src = __webpack_exports__["default"] = (src_SvgSketchCanvas);
